...
import { Logger, ExpressService, TunnelService, SlackService, MensaService } from '@home/core';
...
(async () => {
    ...
    try {
        const mensa = await MensaService.init(mensaConfig);
        Logger.info(`Mensa initialized`);
    } catch (e) {
        Logger.error(e);
        process.exit(1);
    }
